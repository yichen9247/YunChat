...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
        ...
        private final AndroidxMultidexLibraryAccessors laccForAndroidxMultidexLibraryAccessors = new AndroidxMultidexLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.multidex</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public AndroidxMultidexLibraryAccessors getMultidex() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForAndroidxMultidexLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class AndroidxMultidexLibraryAccessors extends SubDependencyFactory {

        public AndroidxMultidexLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>multidex2</b> with <b>androidx.multidex:multidex</b> coordinates and
         * with version reference <b>androidxMultidexVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getMultidex2() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("androidx.multidex.multidex2");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidxMultidexVersion</b> with value <b>2.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAndroidxMultidexVersion() { return getVersion("androidxMultidexVersion"); }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Group of versions at <b>versions.androidx.multidex</b>
         */
    ...
    public static class AndroidxMultidexVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.multidex.multidex2</b> with value <b>2.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMultidex2() { return getVersion("androidx.multidex.multidex2"); }
